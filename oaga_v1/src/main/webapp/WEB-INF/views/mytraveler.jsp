...
<link rel="stylesheet" type="text/css"
	href="/oaga/css/mytraveler/homestyle.css" />
...
<section class="myt-sec1">
	<div class="sec1Wrap">
		...
		<div class="best-subtitle">
			<div class="subtitle">회원들에게 좋아요를 가장 많이 받은 인기 리뷰어</div>
		...
		<div class="best-list">
			...
			<c:forEach var="userList" items="${bestUserList}" varStatus="status">
				<a href="/oaga/userpage_form/${userList.id}">
					<div class="item-div">
						<span class="css-1juk5to-RankNumber">${status.index + 1}</span> <img
							class="item-img"
							src="http://localhost:9090/oaga/upload/${userList.userProfileImgUrl}"
	...
	<div class="sec1Wrap">
		...
		<div class="my-list">
			...
			<c:forEach var="following" items="${followingList}">
				<a href="/oaga/userpage_form/${following.followedUser.id}">
					<div class="list-item">
						<img class="mylist-img"
							src="http://localhost:9090/oaga/upload/${following.followedUser.userProfileImgUrl}"
							onerror="this.src='images/reviewPage/profile_basic.png';">
...
<section class="myt-sec3">
	<div class="sec3Wrap">
		<div class="review-div">
			...
			<div class="subtitle">나와 여행 취향이 비슷한 회원들의 리뷰를 참고하여 더욱 즐겁고 완벽한
				여행을 계획하세요!</div>
			<div class="list-row">
				<c:forEach var="review" items="${reviewList.content}">
					<div class="box">
						<a href="/oaga/detail/${review.id}">
							<div class="ImgBox">
								<img
