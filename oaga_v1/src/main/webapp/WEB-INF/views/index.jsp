...
<%@ include file="layout/header.jsp"%>
    ...
    <div class="mainBn">
      <div class="bnWrap">
        <h2>우리의 국내여행 커뮤니티, <span>오늘 어디가지?</span></h2>
        <p class="tit">100만 사용자들의 여행리뷰를 확인하세요.</p>
        <div class="srchBox">
          <form class="srch2">
            <input type="text" placeholder="도시명으로 검색" />
            <button class="Q2"><img src="images/mainpage/icon_search1.gif" alt="" /></button>
          </form>
          <!--srch2-->
    ...
    <section class="sec1">
      <div class="secWrap">
        <h3><span>OaGa</span>에서 여행을 시작하세요!</h3>
