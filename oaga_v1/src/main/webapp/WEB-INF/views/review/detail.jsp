	...
	<div class="reviewDetailForm">
		<div class="reviewDetailWrap">
			...
			<div class="reviewDetailBody">
				<h3 class="contentTitle">부산 3박4일 여행</h3>
				<div class="contentThemeBox">여행 테마</div>
				<!--contentTitle-->
				...
				<div class="reviewDetail_profile">
					...
					<div class="profile_namebox">
						<h6 class="profile_name">작성자</h6>
					</div>
					<div class="profile_likes">좋아요 : 100</div>
				</div>

				<div class="contentBody">
					<div class="contentBody_row1">
						<div class="OagaPlace">
							<a href="#">[사진] 리뷰 작성할 때 선택한 OaGa의 Places</a>
						</div>
						<div class="OagaPlace">
							<a href="#">[사진] 리뷰 작성할 때 선택한 OaGa의 Places</a>
						</div>
	...
	<footer>
		<div class="fWrap">
			<div class="ftrow1">
				...
				<div class="box">
					...
					<div class="icon">
						<img class="ico1" src="images/mainpage/sns_fb.png" alt="" /> <img
							src="images/mainpage/sns_nv.png" alt="" />
					</div>
					<!--icon-->
				</div>
				<!--box-->
		...
		<div class="footerbottom">
			<div class="fWrap ftrow2">
				<p class="lefttxt">Copyright ⓒ 2022 Earthtory.com???, All Rights
					Reserved.</p>
