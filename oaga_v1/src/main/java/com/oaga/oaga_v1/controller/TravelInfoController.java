...
public class TravelInfoController {
	...
	public String guInfoList(Model model, @PathVariable int areaGu) {
		...
		List<HotPlace> guInfoList = travelInfoService.guInfo(areaGu);
		...
		return "/travelInfo/hotplace_form";
	}
	...
	public String getDetailGu(Model model, @PathVariable int id) {
		...
		List<HotPlace> guInfoFindById = travelInfoService.findByGuinfoId(id);
